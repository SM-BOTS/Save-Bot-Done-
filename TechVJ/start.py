    ...
    if "https://t.me/" in message.text:
        ...
        for msgid in range(fromID, toID+1):
            ...
            # bot
                ...
                username = datas[4]
                try:
                    await client.send_message(message.chat.id, "Bot links are not supported directly in handle_private. Use standard text/media processing.", reply_to_message_id=message.id)
                except Exception as e:
                    if ERROR_MESSAGE == True:
                        await client.send_message(message.chat.id, f"Error: {e}", reply_to_message_id=message.id)
            ...
            # 🚀 DELAY REMOVED: Pehle yahan sleep interval tha jo ab humne hata diya h instant processing k liye
            pass
